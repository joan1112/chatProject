...
#define DEFAULT_FILL_COLOR              [UIColor colorWithRed: 24/255.0 green: 103/255.0 blue: 184/255.0 alpha: .68]
#define DEFAULT_FILL_SELECTED_COLOR     [UIColor colorWithRed: 1/255.0 green: 50/255.0 blue: 84/255.0 alpha: 1]
...
#define DEFAULT_TEXT_COLOR              [UIColor colorWithRed: 95/255.0 green: 212/255.0 blue: 255/255.0 alpha: 1]
#define DEFAULT_TEXT_SELECTED_COLOR     [UIColor colorWithRed: 95/255.0 green: 212/255.0 blue: 255/255.0 alpha: 1]
...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i = 0; i < self.mapPath.textRectArray.count; i++) {
        ...
        NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize: 9], NSForegroundColorAttributeName: self.textColorArray[i], NSParagraphStyleAttributeName: textStyle};
