...
@objc enum ARWindowViewStats:Int {
    /* 接听等待 视频接听 音频or多人  */
...
//            rtcKit.setupRemoteVideo(videoCanvas)
    ...
    @objc  class func loadWindowView(time: String, status: ARWindowViewStats, vc: UIViewController) {
        removeWindowView()
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if startFrameLocation == currentLocation {
            ...
            if containVc is AudioViewController {
//                let signalVc = containVc as! AudioViewController
