...
//  TIDE-mobile
//
//  Created by junqiang on 2022/5/16.
//
...
-(void)loadSubView{
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.nim_width, self.nim_height) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.messageLabel.textColor = kUIColorFromRGB(0x6DA9E4);
    cell.messageLabel.font = [UIFont systemFontOfSize:10];
...
- (void)onSelectedRecent:(NIMRecentSession *)recentSession atIndexPath:(NSIndexPath *)indexPath{
    if ([self.delegate respondsToSelector:@selector(onSelectedRecent:atIndexPath:)]) {
        [self.delegate onSelectedRecent:recentSession atIndexPath:indexPath];
    }
